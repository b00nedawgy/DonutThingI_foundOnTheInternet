...
phi_spacing = 1     #controls downward density among the primary circle 360
...
#or display_surface = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
pygame.display.set_caption("Donut")
font = pygame.font.SysFont("Ariel",18,bold=True)
...
while run:
    ...
    z = [0] * screen_size   #Donut.fill donut space
